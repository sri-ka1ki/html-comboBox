...
export function comboBox(opts = {}) {
  ...
  function toggle() {
    return mask.parentElement ? hide() : show();
  }

  function show() {
    document.body.append(mask, optionsContainer);
    ...
    function animateHeight() {
      if (current_height >= _height) {
        return scroll && (optionsContainer.style.overflowY = 'scroll');
      }
   ...
   */
  function addOption(option, value = '', preventAddingOption = undefined) {
